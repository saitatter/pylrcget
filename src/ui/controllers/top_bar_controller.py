...
class TopBarController(QWidget):
    ...
    def bind_tab_order(self, window, tabs_widget) -> None:
        window.setTabOrder(self.search_box, self.chk_synced)
        window.setTabOrder(self.chk_synced, self.chk_plain)
        window.setTabOrder(self.chk_plain, self.chk_instr)
        window.setTabOrder(self.chk_instr, self.chk_none)
        window.setTabOrder(self.chk_none, self.btn_refresh)
