...
class DownloadProgressOverlay(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None, *, verb: str = "Download"):
        ...
        set_layout_spacing(self.actions_row, spacing=SPACE_2)
        self.actions_row.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.retry_failed_btn.setObjectName("DownloadOverlayStop")
        self.retry_failed_btn.hide()
        self.retry_failed_btn.clicked.connect(self.retryFailedRequested.emit)
        self.actions_row.addWidget(self.retry_failed_btn)
        self.actions_row.addWidget(self.stop_btn)
        card_layout.addLayout(self.actions_row)
